...
namespace OrderSystem.Migrations
{
    ...
    [Migration("20230905071041_modifyStatus_OrdersTable")]
    partial class modifyStatus_OrdersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderSystem.Entities.Division", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderSystem.Entities.Food", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderSystem.Entities.FoodType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OrderSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OrderSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OrderSystem.Entities.Customer", b =>
                {
                    b.HasOne("OrderSystem.Entities.Division", "Division")
                        .WithMany()
            ...
            modelBuilder.Entity("OrderSystem.Entities.Food", b =>
                {
                    b.HasOne("OrderSystem.Entities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrderSystem.Entities.FoodType", "FoodType")
                        .WithMany()
