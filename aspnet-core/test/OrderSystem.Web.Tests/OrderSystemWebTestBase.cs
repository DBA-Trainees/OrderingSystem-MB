...
{
    public abstract class OrderSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrderSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrderSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrderSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrderSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrderSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrderSystemDbContext, Task<T>> func)
        {
            T result;
