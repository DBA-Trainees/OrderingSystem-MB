        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'orders', component: OrdersComponent, data: { permission: 'Pages.OrderVendor'}, canActivate: [AppRouteGuard] },
                    { path: 'foodList', component: FoodListInformationComponent,data: { permission: 'Pages.FoodList'},canActivate: [AppRouteGuard] },
                    { path: 'customer-cart', component: CustomerCartComponent, data: { permission: 'Pages.CustomerCart'}, canActivate: [AppRouteGuard] },
                    { path: 'dashboard', component: CustomerDashboardComponent, data: { permission: 'Pages.DashBoard'}, canActivate: [AppRouteGuard] },
                    {path: 'foodList/FoodDetails', component: AddToCartDetailsComponent,  data: { permission: 'Pages.FoodList'},canActivate: [AppRouteGuard],},
                    {path: 'reports', component: ReportsComponent, canActivate: [AppRouteGuard]},
                    {path: 'nextStage', component: NextStageComponent, canActivate: [AppRouteGuard]},
